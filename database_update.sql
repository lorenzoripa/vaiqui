...
ALTER TABLE users ADD COLUMN IF NOT EXISTS template VARCHAR(50) DEFAULT 'default';
ALTER TABLE users ADD COLUMN IF NOT EXISTS background_type VARCHAR(20) DEFAULT 'gradient';
ALTER TABLE users ADD COLUMN IF NOT EXISTS background_color VARCHAR(7) DEFAULT '#667eea';
ALTER TABLE users ADD COLUMN IF NOT EXISTS background_gradient VARCHAR(200) DEFAULT 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)';
ALTER TABLE users ADD COLUMN IF NOT EXISTS background_image VARCHAR(255) DEFAULT NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS text_color VARCHAR(7) DEFAULT '#ffffff';
ALTER TABLE users ADD COLUMN IF NOT EXISTS link_style VARCHAR(50) DEFAULT 'card';
ALTER TABLE users ADD COLUMN IF NOT EXISTS link_color VARCHAR(7) DEFAULT NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS link_hover_color VARCHAR(7) DEFAULT NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS button_border_radius INT DEFAULT 12;
ALTER TABLE users ADD COLUMN IF NOT EXISTS button_shadow BOOLEAN DEFAULT TRUE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS font_family VARCHAR(100) DEFAULT 'system';
ALTER TABLE users ADD COLUMN IF NOT EXISTS profile_layout VARCHAR(50) DEFAULT 'centered';
ALTER TABLE users ADD COLUMN IF NOT EXISTS show_social_icons BOOLEAN DEFAULT TRUE;
