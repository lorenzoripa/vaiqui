...
function createTables($pdo) {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS users (
        ...
        social_tiktok VARCHAR(200) DEFAULT NULL,
        ...
        background_gradient VARCHAR(200) DEFAULT 'linear-gradient(135deg, #667eea 0%, #ff8c42 100%)',
        link_style VARCHAR(50) DEFAULT 'card',
        link_color VARCHAR(7) DEFAULT NULL,
        link_hover_color VARCHAR(7) DEFAULT NULL,
        button_border_radius INT DEFAULT 12,
        button_shadow BOOLEAN DEFAULT TRUE,
        profile_layout VARCHAR(50) DEFAULT 'centered',
